...
@section('title', 'Ramon - Outpatient Minor Surgery')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <select name="savings_type" class="form-control" required>
                                <option value="">Ramon - Outpatient Minor Surgery</option>
                                <!-- <option value="Approved">Ramon</option>
                        ...
                        <div class="text-left mt-4">
                            ...
                            <a href="{{ route('dataContribution.add_Incedent_contribution') }}" class="btn btn-secondary ml-2">Back</a>
                        </div>
                    </div>
                </div>
            </div>
